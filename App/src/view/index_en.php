...
<section class="hero">
  ...
  <div class="hero-content">
    <h1>
      WELCOME TO <span class="site_nom">GL'EAUBAL</span>
    </h1>

    <p>
    Climate change is one of the major challenges we face today,
    affecting the oceans, causing rising temperatures, disrupting
    marine biodiversity, and even acidifying the water.

      These phenomena are invisible to the naked eye but are important to understand in order
      to predict the long-term consequences and, if possible, avoid the worst. <br><br>

      Our application allows you to visualize the effects of climate change
      on the oceans using different APIs.
    </p>
  </div>
</section>
...
<section class="impact">
  ...
  <div class="stats">
    <div class="stat">
      ...
      <p>Average global increase of °C</p>
    </div>

    <div class="stat">
      <span class="donnees" data-target="40">0</span>
      <p>% of lost Arctic ice</p>
    </div>

    <div class="stat">
      <span class="donnees" data-target="532">0</span>
      <p>billion of lost ice tons (Greenland)</p>
    </div>
  </div>

  <div class="themes">
    <a href="router.php?action=UsePage_phenomenes&lang=Francais#temp" class="carte">
      <h3>Rising temperatures & melting ice</h3>
      <p>CO₂, droughts, sea ice, rising sea levels, glaciers</p>
    </a>
    ...
    <a href="router.php?action=UsePage_phenomenes&lang=Francais#sal" class="carte">
      <h3>Salinity variation</h3>
      <p>Evaporation, precipitation, PSU, estuaries</p>
    </a>
  </div>
</section>
...
<section class="downloads">
  ...
  <div class="downloads-grid">
    ...
    <div class="download-card">
      <h3>Chlorophyll A</h3>
      <p>Phytoplankton concentration indicator</p>
